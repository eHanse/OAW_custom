...
#     @http.route('/my_field_sup_ref_into_tree_view/my_field_sup_ref_into_tree_view/objects/<model("my_field_sup_ref_into_tree_view.my_field_sup_ref_into_tree_view"):obj>/', auth='public')
